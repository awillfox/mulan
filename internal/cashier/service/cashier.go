...
func (s *Service) Create(ctx context.Context, loginID, name, pin string) (sqlc.Cashier, error) {
	loginID = strings.TrimSpace(loginID)
...
func (s *Service) Update(ctx context.Context, id int32, name string, active bool) (sqlc.Cashier, error) {
