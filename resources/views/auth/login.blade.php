          ...
          <div class="content">
            <form method="POST" action="{{ route('login') }}">
              ...
              <div class="form-group row block">
                ...
                <input id="email" type="email" class="input @error('email') is-danger @enderror block" name="email"
              ...
              <div class="form-group row block">
                ...
                <div class="col-md-6">
                  ...
                  <input id="password" type="password" class="input @error('email') is-danger @enderror" name="password"
